        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedReason = table.Column<string>(type: "text", nullable: true),
                    EncryptedAdditionalNotes = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrivacyRequests_RequestedAt",
                table: "PrivacyRequests",
                column: "RequestedAt");

            migrationBuilder.CreateIndex(
                name: "IX_PrivacyRequests_User_Type_Status",
                table: "PrivacyRequests",
                columns: new[] { "UserId", "RequestType", "Status" });
        }
