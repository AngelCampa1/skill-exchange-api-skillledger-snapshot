...
export const alt = 'SkillLedger Barter Valuation Calculator'
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ fontSize: 20, color: '#94a3b8', display: 'flex' }}>
            Calculate fair exchange values for your professional skills
          </div>
        </div>
        <div style={{ fontSize: 16, color: '#64748b', display: 'flex' }}>
          skillledger.app/tools/barter-valuation-calculator
        </div>
      </div>
    ),
    { ...size }
