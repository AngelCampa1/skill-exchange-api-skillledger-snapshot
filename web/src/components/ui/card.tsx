...
const CardHeader = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div ref={ref} className={`flex flex-col space-y-3 p-8 ${className || ""}`} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={`text-subheading text-foreground ${className || ""}`}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <p ref={ref} className={`text-body text-muted-foreground ${className || ""}`} {...props} />
))
